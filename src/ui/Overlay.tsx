...
export function Modal({ title, onClose, children }: {
  ...
  return (
    <>
      <div className="modal-scrim absolute inset-0 z-40 bg-[rgba(38,36,31,0.34)]" onClick={onClose} />
...
function Scrim({ onClick }: { onClick: () => void }) {
  return <div className="scrim absolute inset-0 z-30 bg-[rgba(38,36,31,0.28)]" onClick={onClick} />;
}
